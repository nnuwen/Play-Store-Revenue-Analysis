...
# Business Problem 
The goal of this project is to understand which application characteristics contribute to revenue decreases, increases, and customer engagement. 
...
## Analysis Process 
1. Reviewed dataset and checked for errors and duplicates.
